			...
			<div className="voting_people">
				<label className="vote_topic_people">
					<div className="user_people">
						...
						<h2 className="vote_name">John Taggart</h2>
					</div>
				...
				<label className="vote_topic_people">
					<div className="user_people">
						...
						<h2 className="vote_name">Thomas Benedict</h2>
					</div>
					<div className="inputs">
						<input type="radio" name="voteable" className="radioo" />
						<span className="checkmark"></span>
				...
				<label className="vote_topic_people">
					<div className="user_people">
						...
						<h2 className="vote_name">Claire Renalds</h2>
					</div>
					<div className="inputs">
						<input type="radio" name="voteable" className="radioo" />
						<span className="checkmark"></span>
				...
				<label className="vote_topic_people">
					<div className="user_people">
						...
						<h2 className="vote_name">Sara Spencer</h2>
					</div>
					<div className="inputs">
						<input type="radio" name="voteable" className="radioo" />
						<span className="checkmark"></span>
